...
const services: ServiceItem[] = [
  {
    ...
    description: 'Wspieramy przedsiębiorców na każdym etapie: od rejestracji firmy po codzienną obsługę formalną i podatkową. Zapewniamy praktyczne doradztwo oraz sprawny start działalności.',
    items: [
    ...
    detailItems: [
      { icon: 'invoice', text: 'Rejestracja działalności i spółek w odpowiednich rejestrach' },
  ...
  },
  {
    ...
    description: 'Kompleksowa obsługa finansowo-księgowa spółek oraz podmiotów prowadzących pełne księgi rachunkowe, zapewniająca zgodność z przepisami i rzetelną informację zarządczą.',
    items: [
  ...
  },
  {
    ...
    detailLead: 'Zapewniamy sprawną i zgodną z przepisami obsługę kadrowo-płacową, dzięki czemu pracodawca ma pewność, że wszystkie obowiązki wobec pracowników i instytucji są realizowane prawidłowo i na czas.',
    detailTitle: 'Zakres usług',
    detailItems: [
      ...
      { icon: 'shield', text: 'Informowanie o terminach badań lekarskich i szkoleń BHP' },
  ...
  },
  {
    ...
    detailItems: [
      ...
      { icon: 'invoice', text: 'Przygotowanie sprawozdań statystycznych GUS' },
