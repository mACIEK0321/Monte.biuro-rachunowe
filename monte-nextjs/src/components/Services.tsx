...
const servicesDataPL: Omit<ServiceItem, 'svgPath'>[] = [
  {
    ...
    detailLead: 'Zapewniamy uporządkowany proces rozpoczęcia działalności oraz bieżące wsparcie w obowiązkach administracyjnych.',
  ...
  },
  {
    ...
    description: 'Korzystamy z zaawansowanego systemu księgowego, który umożliwia wygodną współpracę i zapewnia stały dostęp do danych finansowych.',
    items: [
    ...
    detailLead: 'System wspiera codzienną współpracę z klientem, porządkuje dokumenty oraz umożliwia bieżącą kontrolę podatków i wyników finansowych.',
    detailTitle: 'Zakres usług',
    detailItems: [
  ...
  },
  {
    ...
    description: 'Księgowość dla JDG i małych firm z pełną kontrolą nad rozliczeniami i terminowością.',
    items: [
    ...
    detailLead: 'Dbamy o to, aby rozliczenia były proste i zrozumiałe, a przedsiębiorca miał pewność, że wszystkie obowiązki są realizowane na czas.',
    detailTitle: 'Zakres usług',
    detailItems: [
  ...
  },
  {
    ...
    description: 'Kompleksowa obsługa finansowo-księgowa spółek zapewniająca zgodność z przepisami i rzetelną informację zarządczą.',
    items: [
    ...
    detailLead: 'Zapewniamy rzetelne prowadzenie ksiąg oraz terminowe raportowanie, dostarczając zarządom przejrzyste informacje o sytuacji finansowej.',
    detailTitle: 'Zakres usług',
    detailItems: [
      { icon: 'book', text: 'Prowadzenie ksiąg zgodnie z ustawą o rachunkowości' },
      { icon: 'calculator', text: 'Sporządzanie bilansu i rachunku zysków i strat' },
      { icon: 'book', text: 'Przygotowanie polityki rachunkowości i planu kont' },
      { icon: 'invoice', text: 'Raporty finansowe na potrzeby zarządu' },
      { icon: 'shield', text: 'Nadzór nad poprawnością księgowań' },
      { icon: 'people', text: 'Wsparcie w kontaktach z audytorami' },
    ],
  },
  {
    title: 'Podatki i deklaracje',
    description: 'Kompleksowa obsługa rozliczeń podatkowych i ZUS z bieżącą kontrolą zobowiązań i terminów.',
    items: [
    ...
    detailLead: 'Zapewniamy terminowe przygotowanie deklaracji oraz pełną kontrolę nad zobowiązaniami podatkowymi.',
    detailTitle: 'Zakres usług',
    detailItems: [
      { icon: 'invoice', text: 'Prowadzenie ewidencji VAT' },
      { icon: 'invoice', text: 'Sporządzanie i składanie deklaracji VAT' },
      { icon: 'cash', text: 'Zestawienie podatków i składek do zapłaty' },
      { icon: 'zus', text: 'Obsługa rozliczeń ZUS przedsiębiorcy' },
      { icon: 'invoice', text: 'Roczne rozliczenia podatkowe' },
      { icon: 'cash', text: 'Wsparcie w bieżących wyjaśnieniach podatkowych' },
    ],
  },
  {
    title: 'Kadry, płace i BHP',
    description: 'Kompleksowa obsługa pracowników i obowiązków pracodawcy - od zatrudnienia po bieżące rozliczenia.',
    items: [
    ...
    detailLead: 'Zapewniamy sprawną obsługę kadrowo-płacową, dzięki czemu pracodawca ma pewność prawidłowej realizacji obowiązków.',
    detailTitle: 'Zakres usług',
    detailItems: [
      ...
      { icon: 'invoice', text: 'Dokumenty związane z zatrudnieniem' },
      { icon: 'shield', text: 'Terminy badań lekarskich i szkoleń BHP' },
      { icon: 'people', text: 'Wsparcie w bieżących sprawach kadrowych' },
    ],
  },
  {
    title: 'Doradztwo i usługi specjalistyczne',
    description: 'Wsparcie właścicieli i zarządów w podejmowaniu decyzji finansowych i planowaniu rozwoju.',
    items: [
    ...
    detailLead: 'Dostarczamy analizy, rekomendacje i praktyczne rozwiązania wspierające stabilny rozwój biznesu.',
    detailTitle: 'Zakres usług',
    detailItems: [
      { icon: 'calculator', text: 'Analizy finansowe i interpretacja wyników' },
      { icon: 'invoice', text: 'Wsparcie w planowaniu podatkowym' },
      { icon: 'cash', text: 'Dane i raporty dla banków lub inwestorów' },
      { icon: 'people', text: 'Doradztwo przy zmianach struktury działalności' },
      { icon: 'book', text: 'Konsultacje finansowe dla zarządu' },
      { icon: 'book', text: 'Uporządkowanie procesów finansowych' },
    ],
  },
  {
    title: 'Sprawozdawczość, audyty i kontrole',
    description: 'Wsparcie w raportowaniu i bezpieczna reprezentacja firmy podczas kontroli.',
    items: [
    ...
    detailLead: 'Zapewniamy bezpieczeństwo w relacjach z urzędami, przygotowując dokumenty i wspierając na każdym etapie kontroli.',
    detailTitle: 'Zakres usług',
    detailItems: [
      { icon: 'invoice', text: 'Sporządzanie sprawozdań finansowych' },
      { icon: 'invoice', text: 'Sprawozdania statystyczne GUS' },
      { icon: 'shield', text: 'Wsparcie podczas kontroli podatkowych i ZUS' },
      { icon: 'people', text: 'Dokumenty i wyjaśnienia dla instytucji' },
      { icon: 'book', text: 'Współpraca z audytorami i biegłymi rewidentami' },
      { icon: 'people', text: 'Reprezentacja w kontaktach z urzędami' },
    ],
  },
];
